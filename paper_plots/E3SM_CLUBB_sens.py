...
'anvil-centos7.base2.wpxpri_3p3e4_1_3_0_12_C7ri_xp2eqwpxp.ne16_ne16',\
...
if drawclubb:
    ...
    vname   = [ "~V25~~F19~9~V-30~~H-40~~F10~w~N~'~S~~F10~2~N~","~V25~~F19~9~V-30~~H-40~~F10~w~N~'~S~~F10~3~N~"]
    cscale   = [  100,   100 ]
